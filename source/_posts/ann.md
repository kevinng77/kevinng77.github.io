...
+ $$Score(Q, d) = \sum W_iR(q_i,d)$$ 
  ...
  + 单词 $$q$$ 与文档 $$d$$ 相关性 $$R()$$ 的计算：$$f_i$$ 为 t 在文档 $$d$$ 中的词频，$$qf_i$$为 $$q_i$$ 在query中的词频。$$dl$$=当前doc长度$$k_1，k_2，b$$是超参，通常为 $$1，2，0.75$$。
...
K 越大表示d文档的长度越长，所包含的信息可能就越多。

k1 越大，我们越看重单词在文档d中词频的影响。k2越大，越看重单词在query中的词频。
...
+ 按照文档id顺序，建立词条序列（储存搜索词与对应文档id的数据对）
